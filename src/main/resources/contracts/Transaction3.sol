...
contract Transaction{
    ...
    function getAllBank() public view returns (string[] memory){
        return bankNames;
    }

    function getAllCustomer() public view returns (string[] memory){
        return customerNames;
    }

    function getAllStatement() public view returns (Statement[] memory){
        return statements;
    }
}